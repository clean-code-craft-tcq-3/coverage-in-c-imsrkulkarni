...
- Enter Reflections: Replace the `Done` in the **Reflections** section below, within this file. This workflow fails till you replace it with your impressions.
...
Writing a readable code which can be extended and has lower CCN value
